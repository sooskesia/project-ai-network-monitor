...
This app is strictly privacy-first, meaning the AI analysis happens 100% locally on your machine. You need to install Ollama and pull the specific Qwen3 model the app uses.
Bash
...
git clone https://github.com/YOUR-USERNAME/AI-Network-Watcher.git
